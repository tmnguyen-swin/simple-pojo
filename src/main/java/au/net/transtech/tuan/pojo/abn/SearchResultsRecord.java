...
@XmlType(name = "SearchResultsRecord", propOrder = {
    "abn",
    "dgrFundNameOrPBIENameOrOtherTradingName",
...
public class SearchResultsRecord {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "legalName", namespace = "http://abr.business.gov.au/ABRXMLSearch/", type = JAXBElement.class),
        @XmlElementRef(name = "otherTradingName", namespace = "http://abr.business.gov.au/ABRXMLSearch/", type = JAXBElement.class),
        @XmlElementRef(name = "AWEFName", namespace = "http://abr.business.gov.au/ABRXMLSearch/", type = JAXBElement.class),
        @XmlElementRef(name = "mainTradingName", namespace = "http://abr.business.gov.au/ABRXMLSearch/", type = JAXBElement.class),
        @XmlElementRef(name = "PBIEName", namespace = "http://abr.business.gov.au/ABRXMLSearch/", type = JAXBElement.class),
        @XmlElementRef(name = "businessName", namespace = "http://abr.business.gov.au/ABRXMLSearch/", type = JAXBElement.class),
        @XmlElementRef(name = "mainName", namespace = "http://abr.business.gov.au/ABRXMLSearch/", type = JAXBElement.class),
        @XmlElementRef(name = "dgrFundName", namespace = "http://abr.business.gov.au/ABRXMLSearch/", type = JAXBElement.class)
    })
    protected List<JAXBElement<?>> dgrFundNameOrPBIENameOrOtherTradingName;
    ...
    /**
     * Gets the value of the dgrFundNameOrPBIENameOrOtherTradingName property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dgrFundNameOrPBIENameOrOtherTradingName property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDgrFundNameOrPBIENameOrOtherTradingName().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getDgrFundNameOrPBIENameOrOtherTradingName() {
        if (dgrFundNameOrPBIENameOrOtherTradingName == null) {
            dgrFundNameOrPBIENameOrOtherTradingName = new ArrayList<JAXBElement<?>>();
        }
        return this.dgrFundNameOrPBIENameOrOtherTradingName;
    }
